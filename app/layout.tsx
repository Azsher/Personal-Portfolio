...
export const metadata: Metadata = {
  title: "Oscar Antayhua | Software Engineer & Process Automation Specialist",
  description:
    "Estudiante de Ingeniería de Software especializado en automatización de procesos, análisis de datos y desarrollo web. Experiencia en herramientas de IA y gestión de proyectos.",
  generator: "v0.app",
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={inter.className}>
      ...
      <body>
        {/* Fondo adaptativo completamente fijo - fuera del smooth scroll */}
